...
// ✅ FIX: definir $id_sesion desde la sesión para filtrar propiedades del propietario
$id_sesion = $_SESSION['usuario_sesion']; // Asegúrate que este campo se guarda al hacer login
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            if ($esAdministrador) {
                                ...
                                // ✅ FIX: usar $id_sesion ya definido arriba desde $_SESSION['id_sesion']
                                $id_sesion_escape = mysqli_real_escape_string(conectar(), $id_sesion);
                                $sql = "SELECT * FROM propiedades WHERE id_usuario='$id_sesion_escape' ORDER BY id DESC";
                            }
