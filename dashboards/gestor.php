...
$esGestor = ($_SESSION['nombre_perfil'] === 'Gestor Inmobiliario');
if (!$esGestor) {
    header("Location:../backend/error.html");
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Gestor - PNK Inmobiliaria</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">🏠 Panel Gestor Inmobiliario</a>
    <div class="d-flex">
  ...
  <div class="row">
    ...
    <div class="col-md-2 bg-dark text-white p-3 vh-100">
      ...
      <ul class="nav flex-column">
        <li class="nav-item"><a class="nav-link text-white" href="gestor.php">Inicio</a></li>
